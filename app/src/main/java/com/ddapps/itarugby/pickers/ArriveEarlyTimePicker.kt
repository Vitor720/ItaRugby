...
class ArriveEarlyTimePicker: DialogFragment(), TimePickerDialog.OnTimeSetListener {
    ...
    override fun onTimeSet(view: TimePicker, hourOfDay: Int, minute: Int) {
        val txtViewButton = activity!!.findViewById<View>(R.id.arrive_early) as TextView
